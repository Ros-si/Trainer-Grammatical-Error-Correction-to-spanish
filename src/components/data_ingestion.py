...
class DataIngestion:
    ...
    def download_test_datasets(self):
        ...
        ds_synthetic = ds_synthetic.remove_columns(['tokens', 'error_tags', 'error_type', 'span', 'annotation', 'corrupted_tagged','aux_corrupted_tagged', 'spaces'])
    ...
    def download_dataset(self):
        ...
        if self.config.mode == "synthetic":
            ...
            for split in ['train', 'validation']:
                dataset_synthetic[split] = dataset_synthetic[split].cast(dataset_cowsl2h[split].features)
